// frontend/src/app/home-page/page.tsx
...
export const metadata = {
  ...
  description: `This is the official homepage for the Coastside Amateur \
Radio Club (CARC), featuring meeting information, nets, \
